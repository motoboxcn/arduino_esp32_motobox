...
- **调试数据特征值**: `12345678-1234-1234-1234-123456789ABE`
- **融合调试特征值**: `12345678-1234-1234-1234-123456789ABF`
...
融合调试数据通过特征值UUID `12345678-1234-1234-1234-123456789ABF` 传输，包含详细的融合定位信息：
...
- `fusion_status`: 融合系统状态（"active"/"inactive"/"disabled"）
- `position`: 融合位置信息
  - `lat/lng`: 经纬度
  - `alt`: 海拔高度（米）
  - `speed`: 速度（km/h）
  ...
  - `accuracy`: 位置精度（米）
- `attitude`: 姿态信息
  - `roll/pitch/yaw`: 横滚/俯仰/偏航角（度）
- `fusion_info`: 融合状态信息
  - `position_valid`: 位置数据有效性
  - `accuracy`: 位置精度（米）
- `stats`: 统计信息
  - `uptime`: 系统运行时间（秒）
  - `free_heap`: 可用内存（字节）
...
4. **订阅特征值**: 
   - 遥测数据: `12345678-1234-1234-1234-123456789ABD`
   - 调试数据: `12345678-1234-1234-1234-123456789ABE`
   - 融合调试: `12345678-1234-1234-1234-123456789ABF`
5. **接收数据**: 监听特征值通知，接收JSON格式的数据
